...
class _EditSheetState extends State<EditSheet> {
  final tablets = ['Paracetamol', 'levocetrizen', 'Vicodin', 'Zincovit', 'Others'];
  ...
  Future<void> addSchedule(
    ...
    await Provider.of<GoogleSheetsProvider>(context, listen: false).insert({
      'Time': SelectedTime.toString(),
      'Tablet': Tablet,
      'Type': Type,
            ...
            children: <Widget>[
              ...
              FlatButton(
                ...
                onPressed: () async {
                  ...
                  Navigator.popAndPushNamed(context, '/edit_schedule');
                },
                child: const Text(
                  'Save',
                  style: TextStyle(
